  ...
  return(
    <div className="flex w-10/12 mx-auto mt-20 gap-1 h-max shadow-md " id="about">
      ...
      >
        ...
        <p className="font-light">Hello, I am <b>Ward</b>, I am a front-end Web developer with some knowledge in the backend. I work with JavaScript, React, NodeJS, Express, and MongoDB. Please take a moment to checkout some of my projects below, and do not hesitate to <a className="text-sky-500 text-bold hover:text-cayan-400 cursor-pointer hover:font-bold hover:text-lg" href="mailto:wf.hadid94@gmail.com" target="_blank" rel="noreferer">Contact</a> me for inquiries.</p>
